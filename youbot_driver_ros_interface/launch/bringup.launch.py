...
def generate_launch_description():
    ...
    youbot_driver_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource([os.path.join(
                get_package_share_directory('youbot_driver_ros_interface'), 'launch'),
                '/youbot_driver.launch.py'])
    )
